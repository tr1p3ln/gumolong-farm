...
@section('content')
    ...
    <div class="mb-8 flex items-center justify-between">
        ...
        <div class="hidden md:flex items-center gap-3">
            <div
                class="flex items-center gap-2 text-xs text-gray-400 bg-white border border-gray-200 rounded-lg px-4 py-2.5">
            ...
            @if(in_array(auth()->user()->role, ['super_admin', 'admin']))
                <a href="{{ route('dashboard.export-pdf') }}" target="_blank"
                    class="inline-flex items-center gap-2 bg-[#2E7D32] hover:bg-[#256427] text-white text-xs font-semibold px-4 py-2.5 rounded-lg transition-colors duration-150 shadow-sm">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-5 mb-8">
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
            <div class="flex items-start justify-between mb-4">
                <div class="w-10 h-10 rounded-lg bg-[#2E7D32]/10 flex items-center justify-center">
                    <svg class="w-5 h-5 text-[#2E7D32]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        stroke-width="1.8">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span
                    class="text-[10px] font-semibold uppercase tracking-wider text-[#2E7D32] bg-[#2E7D32]/10 px-2 py-1 rounded-full">Aktif</span>
            </div>
            ...
            <div class="mt-3 pt-3 border-t border-gray-100">
                <p class="text-[11px] text-gray-400">Kapasitas kandang: <span
                        class="font-semibold text-gray-600">{{ $persenOkupansi }}%</span></p>
            </div>
        </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
            <div class="flex items-start justify-between mb-4">
                ...
                <span
                    class="text-[10px] font-semibold uppercase tracking-wider text-blue-500 bg-blue-50 px-2 py-1 rounded-full">Jantan</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
            <div class="flex items-start justify-between mb-4">
                <div class="w-10 h-10 rounded-lg bg-[#607F5B]/10 flex items-center justify-center">
                    <svg class="w-5 h-5 text-[#607F5B]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        stroke-width="1.8">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <span
                    class="text-[10px] font-semibold uppercase tracking-wider text-[#607F5B] bg-[#607F5B]/10 px-2 py-1 rounded-full">Betina</span>
            </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-5 shadow-sm">
            <div class="flex items-start justify-between mb-4">
                <div class="w-10 h-10 rounded-lg bg-[#B14B6F]/10 flex items-center justify-center">
                    <svg class="w-5 h-5 text-[#B14B6F]" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        stroke-width="1.8">
                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                @if($mortalitasBulanIni > 0)
                    <span
                        class="text-[10px] font-semibold uppercase tracking-wider text-[#B14B6F] bg-[#B14B6F]/10 px-2 py-1 rounded-full">Waspada</span>
                @else
                    <span
                        class="text-[10px] font-semibold uppercase tracking-wider text-[#2E7D32] bg-[#2E7D32]/10 px-2 py-1 rounded-full">Aman</span>
                @endif
            </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            @forelse($kandangList as $kandang)
                ...
                <div class="mb-4">
                    <div class="flex justify-between items-center mb-1.5">
                        ...
                        <span
                            class="text-[11px] text-gray-500 ml-2 whitespace-nowrap">{{ $isi }}/{{ $kandang->kapasitas }}</span>
                    </div>
        ...
        <div class="bg-white border border-gray-100 rounded-xl p-6 shadow-sm">
            ...
            <p class="text-xs text-gray-400 mb-5">Feed Conversion Ratio — {{ now()->locale('id')->isoFormat('MMMM YYYY') }}
            </p>
